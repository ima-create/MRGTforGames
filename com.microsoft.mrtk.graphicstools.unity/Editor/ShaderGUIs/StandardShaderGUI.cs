...
namespace Microsoft.MixedReality.GraphicsTools.Editor
{
    ...
    public class StandardShaderGUI : BaseShaderGUI
    {
        ...
        protected static class Styles
        {
            ...
            public static readonly GUIContent emissiveUV = new GUIContent("EmissionUV");
            public static readonly string[] emissiveUVNames = new String[] { "UV0", "UV1", "UV2" };
            public static readonly string emissiveUV0 = "_UV0";
            public static readonly string emissiveUV1 = "_UV1";
            public static readonly string emissiveUV2 = "_UV2";
            ...
            public static readonly GUIContent shadowUV = new GUIContent("ShadowUV");
            public static readonly string[] shadowUVNames = new String[] {"shadowUV0","shadowUV1","shadowUV2"};
            public static readonly string shadowMapUV0 = "_ShadowUV0";
            public static readonly string shadowMapUV1 = "_ShadowUV1";
            public static readonly string shadowMapUV2 = "_ShadowUV2";
            public static readonly GUIContent shadowInt = new GUIContent("ShadowInt", "Shadowintensity");
            ...
            public static readonly GUIContent grayScale = new GUIContent("GrayScale", "GrayScale");
            public static readonly GUIContent enableGrayScale = new GUIContent("GrayScale", "Enable GrayScale");
        ...
        protected MaterialProperty enableGrayScale;
        protected MaterialProperty grayScale;
        ...
        protected MaterialProperty shaodwUV;
        protected MaterialProperty shadowInit;
        ...
        protected override void FindProperties(MaterialProperty[] props)
        {
            ...
            enableGrayScale = FindProperty("_UseGrayScale", props);
            ...
            shaodwUV = FindProperty("_ShadowUV", props);
            shadowInit = FindProperty("_ShadowPower", props);
        ...
        protected void MainMapOptions(MaterialEditor materialEditor, Material material)
        {
            ...
            {
                EditorGUI.indentLevel += 2;
                materialEditor.ShaderProperty(shadowMap, Styles.shadowMap, 2);
                materialEditor.ShaderProperty(shadowInit,Styles.shadowInt);
                EditorGUI.indentLevel -= 2;
                shaodwUV.floatValue = EditorGUILayout.Popup(Styles.shadowUV, (int)shaodwUV.floatValue, Styles.shadowUVNames);
                switch ((ShadowUV)shaodwUV.floatValue)
                {
                    default:
                    case ShadowUV.ShadowUV0:
                    {
                        material.EnableKeyword(Styles.shadowMapUV0);
                        material.DisableKeyword(Styles.shadowMapUV1);
                        material.DisableKeyword(Styles.shadowMapUV2);
                    }
                        break;
                    case ShadowUV.ShadowUV1:
                    {
                        material.EnableKeyword(Styles.shadowMapUV1);
                        material.DisableKeyword(Styles.shadowMapUV0);
                        material.DisableKeyword(Styles.shadowMapUV2);
                    }
                        break;
                    case ShadowUV.ShadowUV2:
                    {
                        material.EnableKeyword(Styles.shadowMapUV1);
                        material.DisableKeyword(Styles.shadowMapUV0);
                        material.DisableKeyword(Styles.shadowMapUV2);
        ...
        protected void FluentOptions(MaterialEditor materialEditor, Material material)
        {
            ...
            materialEditor.ShaderProperty(enableGrayScale,Styles.enableGrayScale);

            if (PropertyEnabled(enableGrayScale))
            {
                materialEditor.ShaderProperty(grayScale,Styles.grayScale,2);
